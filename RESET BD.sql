...
CREATE TABLE IF NOT EXISTS `TousEnVacancesBD`.`CONGE` (
  `ID_DEMANDES_TRAITEES` INT NOT NULL AUTO_INCREMENT,
  `ID_EMPLOYE` INT NOT NULL,
  ...
  PRIMARY KEY (`ID_DEMANDES_TRAITEES`),
...
CREATE UNIQUE INDEX `ID_CONGE_UNIQUE` ON `TousEnVacancesBD`.`CONGE` (`ID_DEMANDES_TRAITEES` ASC) ;
...
INSERT INTO `tousenvacancesbd`.`conge` (`DATE_DEBUT`, `DATE_FIN`, `DUREE_JOURS`, `DATE_DEMANDE`, `ID_EMPLOYE`, `STATUT_DE_LA_DEMANDE`) VALUES ('2019-06-20', '2019-06-27', '5', '2019-04-11', '2', '');
